...
import com.nokia.sample.model.DataOuterClass;
import com.nokia.sample.model.DataOuterClass.Data;
import com.nokia.sample.model.DataOuterClass.Data.Corpus;
...
public class SampleRestController {
	...
	public Data1 getData1(@RequestParam(value = "id", defaultValue = "0") Integer id) {
		// Without Protobuffer
		return new Data1(id, dataList.get(id));
	}
	...
	public Data getData(@RequestParam(value = "id", defaultValue = "0") Integer id) {
		...
		return DataOuterClass.Data.newBuilder().setId(id).setValue(dataList.get(id)).addAllMessageType(typeList)
